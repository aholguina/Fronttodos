...
function consultarClientId(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.103.48:8080/api/Client/' + id,
            type: 'GET',
            dataType: 'json',
...
function guardarInformacionCliente() {
    ...
    if (!passwordC || !ageC || !emailC || !nameC) {
        ...
        $.ajax({
            ...
            url: "http://129.151.103.48:8080/api/Client/save",
...
function actualizarInformacionCliente() {
    ...
    if (!passwordA || !ageA || !emailA || !nameA) {
        ...
        $.ajax({
            url: "http://129.151.103.48:8080/api/Client/update",
            type: "PUT",
            data: dataToSend,
...
function borrarCliente(idElemento) {
    ...
    $.ajax({
        url: "http://129.151.103.48:8080/api/Client/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
