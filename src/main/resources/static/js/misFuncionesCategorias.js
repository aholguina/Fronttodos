    ...
    if( !nameC || !descriptionC){
       alert("Verifique los campos")
        ...
        $.ajax({
            ...
            url: "http://129.151.103.48:8080/api/Category/save",
...
function actualizarInformacionCategorias() {
    ...
    if( !nameA || !descriptionA){
        ...
        $.ajax({
            url: "http://129.151.103.48:8080/api/Category/update",
            type: "PUT",
            data: dataToSend,
...
function consultarCategoryid(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.103.48:8080/api/Category/' + id,
            type: 'GET',
            dataType: 'json',
...
function borrarCategoria(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.151.103.48:8080/api/Category/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
