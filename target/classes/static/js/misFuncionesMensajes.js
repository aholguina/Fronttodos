...
function autoInicioMensajes() {
    ...
    $.ajax({
        url: "http://129.151.103.48:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
...
function consultarMessageid(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.103.48:8080/api/Message/' + id,
            type: 'GET',
            dataType: 'json',
...
function guardarInformacionMensajes() {
   if (!MensajeC) {
        ...
        $.ajax({
            ...
            url: "http://129.151.103.48:8080/api/Message/save",
...
function actualizarInformacionMensaje() {
    if (!MensajeA) {
        ...
        $.ajax({
            url: "http://129.151.103.48:8080/api/Message/update",
            type: "PUT",
            data: dataToSend,
            contentType: "application/JSON",
            datatype: "JSON",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url: "http://129.151.103.48:8080/api/Message/" + idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
                console.log(response);
