...
function autoInicioReservacion() {
    ...
    $.ajax({
        url: "http://129.151.103.48:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
...
function autoInicioRelacionCliente(){
    ...
    $.ajax({
        url:"http://129.151.103.48:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function autoInicioCostume(){
    ...
    $.ajax({
        url:"http://129.151.103.48:8080/api/Costume/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function agregarReservation() {
    ...
    if($("#scoreC").val().length == 0 || $("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0){
        ...
        $.ajax({
            ...
            url:"http://129.151.103.48:8080/api/Reservation/save",
            data: dataToSend,
            datatype: "json",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.103.48:8080/api/Reservation/"+idElemento,
...
function consultarReservasid(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.103.48:8080/api/Reservation/' + id,
            type: 'GET',
            dataType: 'json',
...
function actualizarReservation() {
    ...
    if(!validarFecha()  ){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.103.48:8080/api/Reservation/update",
