function traerReporteStatus() {
    console.log("test");
    $.ajax({
        url: "http://129.151.103.48:8080/api/Reservation/report-status",
        type: "GET",
        datatype: "JSON",
...
function traerReporteDate() {
    ...
    $.ajax({
        url: "http://129.151.103.48:8080/api/Reservation/report-dates/" + fechaInicio + "/" + fechaCierre,
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function traerReporteClientes() {
    $.ajax({
        url: "http://129.151.103.48:8080/api/Reservation/report-clients",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
