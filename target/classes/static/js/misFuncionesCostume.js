...
function autoInicioCategoria() {
    ...
    $.ajax({
        url: "http://129.151.103.48:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
...
function consultarCostumeid(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.103.48:8080/api/Costume/' + id,
            type: 'GET',
            dataType: 'json',
...
function agregarElementos() {
    if (!nameC || !brandC || !yearC || !descriptionC) {
        ...
        $.ajax(
            {
                url: 'http://129.151.103.48:8080/api/Costume/save',
                type: 'POST',
                data: dataToSend,
                dataType: 'json',
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url: "http://129.151.103.48:8080/api/Costume/" + idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
                console.log(response);
        ...
        $.ajax(
            {
                ...
                data: dataToSend,
                contentType: "application/JSON",
                url: "http://129.151.103.48:8080/api/Costume/update",
                type: "PUT",
